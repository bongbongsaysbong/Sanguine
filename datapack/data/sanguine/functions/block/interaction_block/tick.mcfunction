...
execute if score @s sanguine.block_hurt_timer matches 1 on vehicle run data modify entity @s[tag=!sanguine.block_hurt_tint] item.tag.CustomPotionColor set value 16777215
