...
execute positioned ~ ~-1 ~ if block ~ ~ ~ hopper unless entity @e[type=minecraft:item_display,tag=smithed.block,distance=..0.5] run function sanguine:block/noxious_gut/digest/inventory/main
