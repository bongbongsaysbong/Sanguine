...
kill @e[type=minecraft:item_display,tag=sanguine.vile_viscus_drips,distance=..0.05,sort=nearest,limit=1]
playsound sanguine:block.vile_viscus.tip block @a[distance=..16]
