...
execute if score @s[tag=!sanguine.sanguine_urn.brewing] sanguine.dummy matches 2.. if data storage sanguine:storage root.temp.item.tag.sanguine{id:"blood_binding"} run function sanguine:block/sanguine_urn/interact/apply_binding/main
