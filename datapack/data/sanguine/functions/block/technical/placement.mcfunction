execute if data storage nucleus:storage root.block{id:"sanguine:credence"} run function sanguine:block/credence/place/main
execute if data storage nucleus:storage root.block{id:"sanguine:blood_well"} run function sanguine:block/blood_well/place
