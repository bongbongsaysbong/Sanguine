...
execute if entity @s[tag=!sanguine.tuned] as @e[type=#nucleus:preset/can_take_damage/include_players,tag=!smithed.block,tag=!smithed.strict,tag=!sanguine.soul_shriek_victim,distance=..2] unless entity @s[nbt={Invulnerable:1b}] run function sanguine:item/blood_binding/checks/act/soul_shriek/damage/main
execute if entity @s[tag=sanguine.tuned] as @e[type=#nucleus:preset/can_take_damage/include_players,team=!sanguine.flesh_tuner,tag=!smithed.block,tag=!smithed.strict,tag=!sanguine.soul_shriek_victim,distance=..2] unless entity @s[nbt={Invulnerable:1b}] run function sanguine:item/blood_binding/checks/act/soul_shriek/damage/main
