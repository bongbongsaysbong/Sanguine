...
execute if score @s sanguine.binding.blood_deviant matches 1.. run function sanguine:item/blood_binding/checks/act/blood_deviant/update_attributes/reapply
