...
execute summon wandering_trader run function sanguine:entity/anemone/initiate
...
execute if score #debug sanguine.dummy matches 1 run tellraw @s {"translate":"commands.summon.success","with": [{"translate":"entity.sanguine.anemone"}]}
