...
execute if score #sanguine.blood_moon.phase sanguine.dummy matches 0..2 if score #sanguine.daytime sanguine.dummy matches 1 run function sanguine:technical/blood_moon/end
