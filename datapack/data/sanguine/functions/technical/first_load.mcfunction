...
data modify storage sanguine:storage root.version.release set value 5
...
data modify storage sanguine:storage root.gamerules.flesh_tuner set value 1b
data modify storage sanguine:storage root.gamerules.reaper_nerf set value 0b
data modify storage sanguine:storage root.gamerules.spawn_nerf set value 0b
scoreboard players set #sanguine.blood_moon_frequency sanguine.dummy 10
scoreboard players set #sanguine.mob_cap sanguine.dummy 30
