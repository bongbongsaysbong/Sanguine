...
data modify entity @s[tag=!sanguine.has_serum.vigor] ArmorItems[3].tag.sanguine.attack_damage set value 12
data modify entity @s[tag=sanguine.has_serum.vigor] ArmorItems[3].tag.sanguine.attack_damage set value 18
