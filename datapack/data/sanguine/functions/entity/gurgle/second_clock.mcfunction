...
execute unless score @s nucleus.frames matches 1.. if entity @a[distance=..3,gamemode=!spectator,gamemode=!creative] run function sanguine:entity/gurgle/attack
