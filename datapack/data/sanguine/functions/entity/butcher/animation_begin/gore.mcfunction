data modify entity @s ArmorItems[3].tag.nucleus.custom_model_data.idle set value 8361050
data modify entity @s ArmorItems[3].tag.nucleus.custom_model_data.moving set value 8361050
...
tag @s add sanguine.butcher.animation.gore
