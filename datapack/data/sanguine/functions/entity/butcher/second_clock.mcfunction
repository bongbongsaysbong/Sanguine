execute unless score @s nucleus.frames matches 1.. if entity @a[distance=..2,gamemode=!creative,gamemode=!spectator] run function sanguine:entity/butcher/animation_begin/gore
