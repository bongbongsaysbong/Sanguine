execute if score @s nucleus.frames matches 25 run function sanguine:entity/unborn/animation_end
execute if score @s nucleus.frames matches 36 run function sanguine:entity/unborn/damage
