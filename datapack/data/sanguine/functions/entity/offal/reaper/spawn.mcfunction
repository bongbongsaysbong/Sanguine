...
execute store result score #dir sanguine.dummy run loot spawn ~ ~ ~ loot sanguine:technical/rng/1_4
execute store result score #dir2 sanguine.dummy run loot spawn ~ ~ ~ loot sanguine:technical/rng/1_4
