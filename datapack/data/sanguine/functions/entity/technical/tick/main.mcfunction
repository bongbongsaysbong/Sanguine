...
execute if entity @s[tag=sanguine.block] if entity @a[limit=1,distance=..128] run function sanguine:block/tick
execute if entity @s[tag=sanguine.credence] positioned ~ ~-1 ~ run function sanguine:block/credence/tick
execute if entity @s[tag=sanguine.interaction_block] if entity @a[limit=1,distance=..128] run function sanguine:block/interaction_block/tick
