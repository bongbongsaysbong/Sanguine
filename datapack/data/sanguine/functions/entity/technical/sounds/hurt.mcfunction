execute if entity @s[tag=sanguine.unborn] run playsound sanguine:entity.unborn.hurt hostile @a
execute if entity @s[tag=sanguine.offal] run playsound sanguine:entity.offal.hurt hostile @a
execute if entity @s[tag=sanguine.reaper] run playsound sanguine:entity.reaper.hurt hostile @a
...
execute if entity @s[tag=sanguine.sanguine_urn] run function sanguine:block/sanguine_urn/hurt
